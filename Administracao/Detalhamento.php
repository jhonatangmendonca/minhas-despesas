        ...
        <main class="container" style="margin-top: 70px;margin-bottom: 70px;">
            ...
            ?>
                        <div class="form-group new-form">
                            ...
                            <br>
                            <br>
                            <input type="hidden" id="Pk" name="Pk" class="form-control form-control-sm" value="<?php echo $Pk ?>">

                            <div class="row">
                                <div class="input-field col s12">
                                    <input id="NomeUsuario" name="NomeUsuario" type="text" class="validate" value="<?php echo $NomeUsuario; ?>" required="">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <input id="Senha" name="Senha" type="text" class="validate" value="<?php echo base64_decode($Senha); ?>" required="">
        ...
        <footer class="indigo darken-2" style="position: fixed; width: 100vw; bottom: 0; z-index: 900; padding-top: 0px; padding-bottom: 0px">
            <div class="row">
                <div class="input-field col s12 center-align">
                    ...
                    <button class="btn waves-effect waves-light red lighten-2" id="BtnExcluir" type="submit" name="action">Excluir
